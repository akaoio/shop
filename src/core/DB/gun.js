    ...
    USE(function (module) {
        ...
        function page(word) {
            var b = this,
                ...
                p = l[i]
            if ("string" == typeof p) {
                l[i] = p = { size: -1, first: b.parse ? b.parse(p) : p, substring: sub, toString: to, book: b, get: b, read: list }
        ...
        function split(p, b) {
            ...
            var L = sort(p),
                ...
                tmp
            //console.timeEnd();
            var next = { first: half.substring(), size: 0, substring: sub, toString: to, book: b, get: b, read: list },
                f = (next.from = [])
            while ((tmp = L[i++])) {
                f.push(tmp)
        ...
        function heal(l, s) {
            ...
            if ((e = i + 2 + parseInt((e = l[i + 1]).substring(0, e.indexOf('"')) || e)) != e) {
                return []
        ...
        function sub(i, j) {
            return (this.first || this.word || B.decode((from(this) || "")[0] || "")).substring(i, j)
        }
        function to() {
