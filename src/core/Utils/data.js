...
export const filterData = (data = {}, prefix = "") => Object.entries(data).filter((item) => typeof item[0] === "string" && item[0].indexOf(prefix) > -1)
...
export const clone = (data, seen = new WeakMap()) => {
